...
$option=$_POST[option];
if($option==="Faculty")
$result = mysqli_query($conn,"SELECT * FROM login where ID='$id_no' ");
elseif($option==="Student")
$result = mysqli_query($conn,"SELECT * FROM login LIMIT 100 where ID='$id_no' ");
...
<body>
  ...
  <div class="container marketing my-5 border rounded" style="background-color:rgba(124, 3, 30, 0.973)">
      <h3 style="color:white">Know Students and Faculty Location</h3>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            <select id="inputState" class="form-control" name="option">
              <option selected>Choose person type</option>
